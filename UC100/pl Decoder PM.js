...
function Decoder(bytes, port) {
    return decode_modbus(bytes);
}

function decode_modbus(bytes) {
    var decoded = {};
        ...
        // MODBUS
            ...
            switch(modbus_chn_id)  {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    modbus_chn_name = "Humidity_Offset";
                    divider = 100;
                    break;
            }
            ...
            switch (type) {
                ...
                case 2:
                case 3:
                    decoded[modbus_chn_name] = (sign ? readInt16LE(bytes.slice(i, i + 2)) : readUInt16LE(bytes.slice(i, i + 2))) / divider;
                    i += 2;
                    break;
                case 4:
                case 6:
                ...
                case 10:
                case 11:
                    decoded[modbus_chn_name] = (sign ? readInt32LE(bytes.slice(i, i + 4)) : readUInt32LE(bytes.slice(i, i + 4))) / divider;
                    i += 4;
                    break;
                case 5:
                case 7:
                    decoded[modbus_chn_name] = (readFloatLE(bytes.slice(i, i + 4))) / divider;
                    i += 4;
                    break;
            }
